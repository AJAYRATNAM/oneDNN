...
*******************************************************************************/
#ifndef GPU_SYCL_GENERIC_LAYER_NORMALIZATION_HPP
#define GPU_SYCL_GENERIC_LAYER_NORMALIZATION_HPP
    ...
    struct pd_t : public gpu_layer_normalization_bwd_pd_t {
        ...
        status_t init(engine_t *engine) {
            ...
            bool ok = is_bwd()
                    ...
                    && utils::one_of(src_md(0)->data_type, f32, bf16, f16)
                    && utils::one_of(diff_dst_md(0)->data_type, f32, bf16, f16)
                    && utils::one_of(diff_src_md(0)->data_type, f32, bf16, f16)
                    && stat_md()->data_type == f32
                    && check_scale_shift_data_type()
